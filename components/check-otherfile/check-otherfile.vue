		...
		<view class="cu-list menu margin-top">
			<view class="cu-item  flex wrap" style="align-items: flex-start;">
					...
					<view style="float: right;" class="padding-top-sm basis-sm">
						...
						<button size="mini" class="cu-btn round" 
							style="margin-left: 20px;margin-right: -10px;" 
							@click="file_download(t_order.orderFileDir)">下载</button>
					</view>
			</view>
			<view class="cu-item flex wrap" style="align-items: flex-start;">  
				...
				<view style="float: right;" class="padding-top-sm basis-xs">
					<button size="mini" class="cu-btn round" 
						style="float: right;" 
						@click="file_download(t_order.orderAccessoryDir)"
			...
			<view class="cu-item flex wrap" style="align-items: flex-start;">
				...
				<view style="float: right;" class="padding-top-sm basis-sm">
					<button size="mini" class="cu-btn round" 
						@click="file_preview(t_order.entrustFileDir)" 
						v-if="whether_entrust_committed">预览</button>
					<button size="mini" class="cu-btn round" 
						style="margin-left: 20px;margin-right: -10px;" 
						@click="file_download(t_order.entrustFileDir)"
			...
			<view class="cu-item flex wrap" style="align-items: flex-start;">
				...
				<view style="float: right;" class="padding-top-sm basis-xs">
					<button size="mini" class="cu-btn round"  style="float: right;"
						@click="file_download(t_order.spotRecordDir)"
						v-if="whether_spot_record_committed">下载</button>
				</view>
			</view>
			<view class="cu-item flex wrap" style="align-items: flex-start;">
				...
				<view style="float: right;" class="padding-top-sm basis-xs">
					<button size="mini" class="cu-btn round" style="float: right;"
						@click="file_download(t_order.spotPictureDir)"
						v-if="whether_spot_picture_committed">下载</button>
				</view>
			</view>
		</view>
	</view>
